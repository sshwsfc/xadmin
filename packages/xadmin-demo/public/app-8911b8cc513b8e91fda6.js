...
var _constants = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"redux-persist/constants\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
...
_xadminCore.app.use(_xadminI18n2.default).use(_xadminForm2.default).use({
  ...
  mappers: mappers, form_fields: form_fields, reducers: reducers
}).use({
  config: {
    locale: {
      lng: 'zh_Hans'
...
//# sourceMappingURL=app-8911b8cc513b8e91fda6.js.map