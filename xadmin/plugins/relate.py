...
class RelateObject(object):
    ...
    def get_brand_name(self):
        if len(self.to_objs) == 1:
            ...
            to_model_name = self.to_model._meta.verbose_name

        return mark_safe(u"<span class='rel-brand'>%s <i class='fa fa-caret-right'></i></span> %s" % (to_model_name, self.opts.verbose_name_plural))
